...
public class AddNewOrder extends BaseTest {

    @Test
    @DisplayName("Add new order. Positive case")
    @Story("Добавление заявки на приобретение домашнего животного, позитивный сценарий")
    public void testAddNewOrderPositive() {
    ...
    @Test
    @DisplayName("Add new order. Negative case")
    @Story("Добавление заявки на приобретение домашнего животного, негативный сценарий")
