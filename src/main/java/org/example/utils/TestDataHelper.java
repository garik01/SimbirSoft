...
public class TestDataHelper {
     ...
     */
    public static final String VALID_PET_STATUS = "available";

    /**
     * Валидный статус заявки
     */
    public static final String VALID_ORDER_STATUS = "placed";

    /**
     * Валидный статус выполнения
     */
    public static final boolean VALID_COMPLETE_STATUS = true;

    /**
     * Валидное количество домашних питомцев
     */
